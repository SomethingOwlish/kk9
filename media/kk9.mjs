...
Hooks.once("init", function () {
  ...
  foundry.documents.collections.Actors.registerSheet("kk9", KK9CharacterSheet, { types:["character"], makeDefault:true, label:"КК9 | Персонаж" });
  foundry.documents.collections.Actors.registerSheet("kk9", KK9NpcLightSheet,  { types:["npc-light"], makeDefault:true, label:"КК9 | НПС лёгкий" });
  foundry.documents.collections.Actors.registerSheet("kk9", KK9NpcHardSheet,   { types:["npc-hard"],  makeDefault:true, label:"КК9 | НПС сложный" });
  foundry.documents.collections.Actors.registerSheet("kk9", KK9NpcBossSheet,   { types:["npc-boss"],  makeDefault:true, label:"КК9 | Босс" });
  foundry.documents.collections.Actors.registerSheet("kk9", KK9ContainerSheet, { types:["container"], makeDefault:true, label:"КК9 | Контейнер" });
  foundry.documents.collections.Actors.registerSheet("kk9", KK9DaemonSheet,    { types:["daemon"],    makeDefault:true, label:"КК9 | Даймон" });
  foundry.documents.collections.Actors.registerSheet("kk9", KK9CompanionSheet, { types:["companion"], makeDefault:true, label:"КК9 | Спутник" });

  foundry.documents.collections.Items.unregisterSheet("core", foundry.appv1.sheets.ItemSheet);
  foundry.documents.collections.Items.registerSheet("kk9", KK9ItemSheet, { makeDefault:true, label:"КК9 | Предмет" });
